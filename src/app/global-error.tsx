    ...
    <html lang="fr">
      ...
      >
        ...
        <p style={{ maxWidth: 380, lineHeight: 1.5, color: "#4c463b", fontSize: "0.9rem" }}>
          Écrivez-nous directement sur WhatsApp pour commander quand même : <strong>+229 01 63 23 41 14</strong>.
        </p>
        <div style={{ marginTop: "1.2rem", display: "flex", gap: "0.7rem" }}>
          ...
          <a
            href="https://wa.me/2290163234114?text=Bonjour%20Techzone%20B%C3%A9nin%2C%20le%20site%20a%20eu%20un%20souci%20technique%2C%20pouvez-vous%20m%27aider%20%3F"
            target="_blank"
